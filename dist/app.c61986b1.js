...
},{"xstate":"../node_modules/xstate/es/index.js"}],"scripts/constants.ts":[function(require,module,exports) {
"use strict";
...
var buttonDisabled = function buttonDisabled(btnStatus) {
  if (btnStatus) {
    constants_1.button.setAttribute("disabled", "");
  } else {
...
exports.init = init;
},{"animejs/lib/anime.es.js":"../node_modules/animejs/lib/anime.es.js","xstate":"../node_modules/xstate/es/index.js","./state":"scripts/state.ts","./constants":"scripts/constants.ts"}],"scripts/card.ts":[function(require,module,exports) {
"use strict";
...
var animateNote = function animateNote(card) {
  ...
  tl.add({
    ...
    complete: function complete() {
      ...
      card.innerHTML = constants_1.cardInner;
      notes.forEach(function (nt) {
        nt.classList.add("note-transform");
      });
      constants_1.notesBlock.prepend(card);
